...
class CapsuleCompiler:
    ...
    def validate(
        ...
        expected_decision_cut_id: str | None = None,
    ) -> bool:
        ...
        if expected_decision_cut_id is not None and capsule.decision_cut_id != expected_decision_cut_id:
            raise CapsuleError("capsule decision cut mismatch")
